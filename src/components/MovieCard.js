...
const MovieCard = ({ posterId, title }) => {
  if (!posterId) return;
  return (
    <div className="w-36 relative hover:border-2 group hover:border-blue-700 hover:shadow-xl m-2 hover:shadow-blue-800 mx-auto transition hover:scale-125 ease-in-out">
